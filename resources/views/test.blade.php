            ...
            <diva class="col-lg-9 col-md-10">
                <div class="card b-0 rounded-0 show">
                    ...
                    <div class="p-3 text-center">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="middle_name" type="text" class="form-control @error('middle_name') is-invalid @enderror" name="middle_name" value="{{ old('middle_name') }}"  placeholder="Enter Middle Name" autofocus>
                        ...
                        </div> <button name="next" type="button" id="next1" class="btn btn-success rounded-0 mb-5 next">START</button>
                    </div>
                </div>
