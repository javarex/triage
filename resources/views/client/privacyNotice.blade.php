<div class="modal fade" id="privacyNotice" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Davao de Oro Contact Tracing
            Privacy Notice </h5>
      ...
      <div class="modal-body">
            <p>
                This privacy notice will help you to understand what Davao de Oro Contract Tracing System (DDOCCTS) collects about you, how DDOCCTS uses this personal data, and what rights you have regarding your personal data.
            </p>
            <p>
            ...
            <ol>
                <li>
                    <strong>What data does Davao de Oro collect and why:</strong>
                    <ul>
                        <li>
                            <strong>Contact Tracing system:</strong> Following the outbreak of Novel Coronavirus (Covid-19), Davao de Oro is controlling access to establishments and offices to safeguard the health and wellbeing of its residents and other visitors. This involves individuals using and providing basic health information so to correlate the tracing of potential contact with persons that have tested positive for the virus.
                        </li>
                        <li>
                            <strong>Other:</strong> Davao de Oro may from time to time collect personal data that is necessary and incidental to the use of  the concerned offices/establishments.
                        </li>
                    </ul>
                </li>
                <li>
                    <strong>The lawful basis for processing your data:</strong> Davao de Oro processes your personal data for the purposes of the legitimate interest pursued by Davao de Oro.  By utilizing the Contact Tracing system and providing your personal data you consent to Davao de Oro processes your personal data for the purposes stated above.
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>You have the right to correct your data if it is incorrect</li>
                        <li>You have the right to obtain from the controller the erasure of your data</li>
                        <li>You have the right to object to your data being processed</li>
                    </ul>
                    <br>
