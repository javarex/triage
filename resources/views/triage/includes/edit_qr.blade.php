      ...
      <div class="modal-body ">
        ...
        <div class="col-12 col-md-12">
            <div class="alert alert-danger" role="alert">
              <p>NOTE: If you have an existing  QRCode  from other provinces, you may use the same.  Just edit   your assigned QRCode.  This is just a one time edit.  For  concerns with your QRCode just email to:
                <br>
