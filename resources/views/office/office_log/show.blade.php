                    ...
                    <div class="col-md-5">
                        <div class="card shadow card-primary">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" name="client_id" value="{{ $activity->client->id }}">
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $activity->client->first_name.' '.$activity->client->last_name }}" readonly>
                                </div>
                            </div>
